...
/*   Updated: 2024/04/09 15:36:24 by cfidalgo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	add_config_to_map(t_state *state, t_point **map,
	void (*configuration) (t_state *state, t_point **map, int x_pos, int y_pos))
{
	int		i;
	int		j;
